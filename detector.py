...
# Try to import all required libraries, but handle gracefully if not available
try:
    import cv2
    import numpy as np
    import face_recognition
    ...
    print("[INFO] Please install all required libraries to use facial recognition features.")
    LIBRARIES_AVAILABLE = False

import threading
from datetime import datetime

# Exit early if libraries are not available
